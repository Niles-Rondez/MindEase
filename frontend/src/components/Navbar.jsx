            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex justify-between h-16">
                    ...
                    <div className="items-center hidden gap-5 space-x-4 text-2xl font-medium md:flex">
                        ...
                        <button className="px-5 py-1 text-white transition-all duration-200 rounded-full hover:text-white hover:bg-purple bg-purple hover:cursor-pointer hover:scale-105 hover:shadow-md/10">+ Journal</button>
                    </div>
