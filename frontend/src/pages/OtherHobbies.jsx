        ...
        <div className="min-h-screen font-sans md:bg-gray-50">
                ...
                <div className="flex items-center justify-center flex-1 px-8">
                    <div className="w-full max-w-2xl">
                        ...
                        <div className="p-8 bg-white shadow-lg/20 rounded-2xl lg:p-10">
                            <h2 className="mb-6 text-2xl font-bold text-plum lg:text-3xl lg:mb-8">Are there any other we might've missed?</h2>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen px-6 py-8 md:hidden">
                <div className="w-full max-w-sm">
                    ...
                    <div className="mb-6">
                        <h1 className="text-3xl font-bold text-plum">Are there any other we might've missed?</h1>
                    </div>
