            ...
            <div className="hidden md:flex h-screen">
                ...
                <div className="flex-1 flex items-center justify-center px-8">
                    <div className="bg-white shadow-lg/20 rounded-2xl p-8 lg:p-10 w-full max-w-md">
                        <h2 className="text-2xl lg:text-3xl font-bold text-center mb-6 lg:mb-8 text-gray-800">Sign Up</h2>
                        <div className="space-y-4">
                            ...
                            <div className="text-center">
                                <p className="text-sm lg:text-base">Already have an account? <a href="#" className="font-medium hover:font-bold transition-all duration-100">Log In</a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="md:hidden flex flex-col min-h-screen justify-center items-center px-6 py-8">
                <div className="w-full max-w-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-center">
                            <p className="text-sm">Already have an account? <a href="#" className="font-medium hover:font-bold transition-all duration-100">Log In</a></p>
                        </div>
                    </div>
                </div>
            </div>
