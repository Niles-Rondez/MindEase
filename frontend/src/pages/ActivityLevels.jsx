...
function ActivityLevels() {
    ...
    const activityLevels = [
        { level: 1, label: "Sedentary", description: "Little to no exercise", icon: "" },
        { level: 2, label: "Lightly Active", description: "Light exercise 1-3 days/week", icon: "" },
        { level: 3, label: "Moderately Active", description: "Moderate exercise 3-5 days/week", icon: "" },
        { level: 4, label: "Very Active", description: "Hard exercise 6-7 days/week", icon: "" },
        { level: 5, label: "Extremely Active", description: "Very hard exercise, physical job", icon: "" }
    ];
    ...
    const handleContinue = () => {
        ...
        // Navigate to Dashboard.jsx
    };

    const handleSkip = () => {
        console.log('Skipped activity level selection');
    };
                        ...
                        <div className="p-12 bg-white border shadow-xl rounded-3xl lg:p-16 backdrop-blur-sm border-white/20">
                            ...
                            <div className="flex flex-col items-center mb-16">
                                <div className="relative h-40 mb-8 w-80">
                                    {/* Gauge Background */}
                                    <svg className="w-full h-full drop-shadow-sm" viewBox="0 0 240 120">
                                        <defs>
                                        ...
                                        {selectedLevel > 0 && (
                                            <path
                                                ...
                                                strokeWidth="20"
                                                strokeLinecap="round"
                                                strokeDasharray={`${(getGaugeRotation(selectedLevel) / 180) * 282.7} 282.7`}
                ...
                <div className="w-full max-w-sm">
                    ...
                    <div className="flex flex-col items-center mb-12">
                        <div className="relative mb-6 w-72 h-36">
                            <svg className="w-full h-full drop-shadow-sm" viewBox="0 0 240 120">
                                <defs>
                                    <linearGradient id="mobileGaugeGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                        <stop offset="0%" stopColor="#ef4444" />
                                        <stop offset="25%" stopColor="#f97316" />
                                        <stop offset="50%" stopColor="#eab308" />
                                        <stop offset="75%" stopColor="#22c55e" />
